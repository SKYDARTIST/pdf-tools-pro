...
const Header: React.FC = () => {
  ...
  return (
    <header className="fixed top-4 left-1/2 -translate-x-1/2 z-50 w-[calc(100%-1.5rem)] max-w-2xl h-12 sm:h-14 monolith-glass rounded-full flex items-center justify-between px-2 sm:px-4 shadow-2xl">
