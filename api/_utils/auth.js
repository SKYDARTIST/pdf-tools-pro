...
export const setSecurityHeaders = (res, origin, allowedOrigins) => {
    ...
    res.setHeader('Access-Control-Allow-Headers', 'Content-Type, Authorization, x-ag-device-id, x-ag-signature, x-ag-timestamp, x-ag-integrity-token, x-csrf-token, x-request-id');
